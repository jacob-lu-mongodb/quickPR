...
fun Cell.eagerBoundTextField(
    prop: KMutableProperty0<String>,
    columns: Int? = null
): CellBuilder<JBTextField> = eagerBoundTextBasedField(JBTextField::class.java, prop, columns)

fun Cell.eagerBoundTextArea(
    prop: KMutableProperty0<String>
): CellBuilder<JBTextArea> = eagerBoundTextBasedComponent(JBTextArea::class.java, prop.toBinding())
...
private fun <T : JTextField> Cell.eagerBoundTextBasedField(
    ...
    prop: KMutableProperty0<String>,
    columns: Int? = null
): CellBuilder<T> = eagerBoundTextBasedField(clazz, prop.toBinding(), columns)
...
private fun <T : JTextComponent> Cell.eagerBoundTextBasedComponent(
    clazz: Class<T>,
    binding: PropertyBinding<String>
): CellBuilder<T> {
